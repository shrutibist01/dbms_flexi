...
<a href="empproj?username=<%= request.getSession().getAttribute("username") %>" ><button class="custom-btn btn-15">View  Projects</button></a>

<a href="empsal?username=<%= request.getSession().getAttribute("username") %>" ><button class="custom-btn btn-15">View Salary</button></a>
