...
<body style="background-color: #6895D2; ">
    ...
    <div class="log-form" style="background-color:rgba(255,255,255,0.5)">
       <h2 style="background-color: #0A6EBD; color: #F6F5F2; font-family: 'Inter UI', sans-serif; font-style: bold;">Add Funds</h2>
  
    <form method="POST">
        <label for="purpose" style="color:#363062">Purpose:</label><br>
    <input type="text" id="purpose" name="purpose" style="margin-top: 10px; background-color: #F6F5F2" required><br>
    <label for="amount" style="color:#363062">Amount:</label><br>
    <input type="number" id="amount" name="amount" style="margin-top: 10px; background-color: #F6F5F2" required><br>
